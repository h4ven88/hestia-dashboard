...
* **Athena voice AI** — wake word detection, Google Neural2 TTS, 50+ language support
...
Open [https://www.hestari.com](https://www.hestari.com) in any browser. On first load the setup wizard will prompt you for your hub IP and Maker API credentials.
...
| **Athena** | Wake word, voice, language, Google TTS API key |
...
| 4 | Single Hubitat app + HPM packaging | ✅ Complete |
| 5 | Athena — voice AI (Google Neural2 TTS, wake word, 50+ languages) | ✅ Complete |
| 6 | Artemis — security integration | 🔵 In progress |
